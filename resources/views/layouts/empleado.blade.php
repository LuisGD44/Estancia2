...
<head>
    ...
    <script>
        function alertaCita() {  
            alert("Se registro correctamente tu trabajo");
        } 
    </script>
      ...
      >
        <div class="space-y-6 md:space-y-10 mt-10">
          ...
          <h1 class="hidden md:block font-bold text-sm md:text-xl text-center">
            Nombre<span class="text-teal-600">.</span>
          </h1>
          <div id="profile" class="space-y-3">
          <a href="{{ route ('vistaEmpleados') }}">
            <img
            ...
            <div>
              <p class="text-xs text-gray-500 text-center">Empleado</p>
            </div>
          </div>
          <div
          ...
          <div id="menu" class="flex flex-col space-y-2">
            ...
            >
              ...
              <span class="">Registrar trabajo realizado</span>
            </a>
            <a
              href="{{ route ('comentarios') }}"
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
            >
              <svg
                class="w-6 h-6 fill-current inline-block"
              ...
              <span class="">Ver Comentarios de los clientes</span>
            </a>
          </div>
        </div>
      </div>
